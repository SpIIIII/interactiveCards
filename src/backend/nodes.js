...
const reqNodes = {
  ...
  "Низкая скорость": { child: ["Есть разрывы", "Пропадания пакетов пинга"], text: "", type: 4 },
...
const factNodes = {
  ...
  "Есть сессия": {
    child: ["Есть разрывы", "Пропадания пакетов пинга", "Устройства не подключены к wifi"],
    text: "",
    type: 2
  },
  ...
  "Есть разрывы": { child: ["Такиеже проблемы у соседей", "Поставить заявку на ближайшее подходящее время"], text: "", type: 2 },
  "Пропадания пакетов пинга": { child: ["Такиеже проблемы у соседей","Поставить заявку на ближайшее подходящее время"], text: "", type: 2 },
